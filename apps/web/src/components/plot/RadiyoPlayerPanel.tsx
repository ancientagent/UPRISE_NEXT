...
export default function RadiyoPlayerPanel({
  ...
  return (
    <section
      ...
      className="mt-3 rounded-[1.3rem] border border-black/15 bg-black px-3.5 py-2.5 text-white shadow-sm transition-all"
    >
      <div className="flex items-start justify-between gap-2.5">
        ...
        <div
          className="shrink-0 rounded-full border border-white/15 bg-white/5 px-2 py-0.5 text-[10px] font-semibold uppercase tracking-[0.16em] text-white/75"
      ...
      <div
        ...
        className="mt-2.5 flex items-stretch gap-2.5 rounded-[1.1rem] border border-white/12 bg-white/[0.04] p-2.5"
      >
        <div className="flex min-w-0 flex-1 items-center gap-2.5">
          ...
          <div className="min-w-0 flex-1">
            ...
            <div className="mt-2.5 flex flex-wrap items-center gap-1.5">
              ...
              <div className="min-w-0 flex items-center gap-1.5 rounded-full border border-white/12 bg-white/[0.03] px-2 py-0.5">
        ...
        {isRadiyoMode ? (
          <div
            ...
            className="flex w-[4.4rem] shrink-0 flex-col gap-1 rounded-[0.95rem] border border-white/12 bg-black/20 p-1.25"
          >
      ...
      <div className="mt-2.5 flex flex-wrap items-center justify-between gap-2.5 rounded-[0.95rem] border border-white/12 bg-white/[0.03] px-2.5 py-1.5">
