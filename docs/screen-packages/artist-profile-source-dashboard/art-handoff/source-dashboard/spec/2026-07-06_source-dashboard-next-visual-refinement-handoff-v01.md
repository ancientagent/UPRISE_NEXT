...
- `art/avatar-system/references/legacy-avatar-boards/0_3 (1).jpeg` as
  referenced by the layout brief for member-avatar direction; read-only, not
  copied or extracted.
