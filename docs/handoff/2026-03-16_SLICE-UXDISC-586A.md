...
- Added discover-adjacent copy explaining that inactive city selection routes onboarding to the nearest active city Scene for the selected Music Community.
- Added explicit pioneer-intent notification wording consistent with the onboarding spec.
- Kept the discovery surface free of pricing, access-limit, or entitlement messaging.

## Drift Guard Confirmation
- Touched locked decision: pioneer routing language now matches onboarding semantics.
- Confirmed unchanged: discovery actions and state model remain unchanged.
- Confirmed unchanged: no entitlement or pricing assumptions were introduced.

## Files Touched
- `apps/web/src/app/discover/page.tsx`
- `docs/CHANGELOG.md`
- `docs/handoff/2026-03-16_SLICE-UXDISC-586A.md`
