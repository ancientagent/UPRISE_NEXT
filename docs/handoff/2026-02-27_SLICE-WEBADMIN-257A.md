# SLICE-WEBADMIN-257A — Registrar client helper dedupe for admin/read endpoint map

## Summary
- Refactored registrar endpoint helper mapping to reduce duplication across promoter/project/sect read/admin-adjacent endpoint construction.
- Preserved existing exported helper signatures and endpoint outputs (no behavior drift).
