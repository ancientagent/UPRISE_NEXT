# SLICE-ADMIN-430A — Registrar revocation invariants regression pack 6

## Scope
- Reinforced revocation invariants and invalid-state regressions in current service/controller paths.
- Added deterministic message parity assertion for non-promoter registrar entry revocation guard.
