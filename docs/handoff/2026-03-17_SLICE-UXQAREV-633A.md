...
Task: Batch18 docs/spec consistency pass

## Scope
- Verified current docs/spec/solution consistency for the active Batch18 lock behavior.
...
- Current `/plot` implementation also keeps the collapsed rail to `Feed`, `Events`, `Promotions`, and `Statistics` only.
