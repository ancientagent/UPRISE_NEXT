...
- Added explicit MVP scope copy stating that Discover search is limited to Scene + Music Community scope.
- Explicitly stated that artist and band lookup is not part of the Discover surface in MVP.

## Drift Guard Confirmation
- Touched locked decision: discovery remains explicit, scene/community-scoped navigation only.
- Confirmed unchanged: no artist/band search entry or result semantics were introduced.
- Confirmed unchanged: no pricing, entitlement, recommendation, ranking, or placeholder CTA behavior was added.

## Files Touched
- `apps/web/src/app/discover/page.tsx`
- `docs/CHANGELOG.md`
- `docs/handoff/2026-03-16_SLICE-UXDISC-582A.md`
