...
Task: Batch18 final gate replay + closeout

## Scope
- Ran the final targeted Batch18 replay for Plot, Discovery, and Player/Profile surfaces.
...
## Residual Notes
- Final targeted Batch18 gate replay is green.
- Batch18 risk/rollback guidance is documented in `docs/handoff/2026-03-17_SLICE-UXQAREV-634A.md`.
