# SLICE-UXGEST-509A — Seam pull-tab affordance contract

## Summary
- Added seam pull-tab affordance contract covering behavior, hit area, labels, and fallback controls.
- Scope is docs-only and spec-aligned.
