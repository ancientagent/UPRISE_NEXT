...
| Sect realization            | Listener request + Registrar-held Artist/Band membership + current member-artist Release Deck threshold (corrected 2026-07-14; former artist-backing motion rule superseded) | Current Registrar/community owner specs; tag-era substrate remains non-authoritative | Agent treats SectTag or songs as sufficient to realize a Sect | Corrected by July 14 founder clarification | no |
