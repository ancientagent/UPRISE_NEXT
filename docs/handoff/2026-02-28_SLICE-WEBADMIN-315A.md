# SLICE-WEBADMIN-315A — Project/sect detail nullable contract assertions pack 2

## Summary
- Extended nullable-field contract assertions for project/sect detail web client reads.
- Added scene-null and scene-present parity checks with nullable payload key coverage.
- No signature or user-action changes.
