...
This is not the complete preference/default/roller runtime implementation. Current-city preference resolution and the roller read model were completed in `docs/handoff/2026-06-25_home-scene-roller-read-model.md`; GPS voting scope across resolvable registered preferences was completed in `docs/handoff/2026-06-25_music-community-preference-voting-scope.md`; expanded listener-profile preference management was completed in `docs/handoff/2026-06-25_music-community-preference-profile-ui.md`; Home/Plot roller consumption was completed in `docs/handoff/2026-06-25_home-scene-roller-plot-consumption.md`; unresolved-profile visibility and eventual compatibility-field cleanup remain follow-up work.
