# SLICE-WEBADMIN-435A — Project/sect nullable mapping assertions pack 6

## Summary
- Extended project/sect list-response nullable mapping parity assertions for present-scene cases.
