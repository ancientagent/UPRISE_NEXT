# SLICE-ADMIN-427A — Registrar code issuance replay safeguards pack 6

## Scope
- Hardened replay/duplicate issuance safeguards for existing approved-entry code paths.
- Added deterministic guard-message parity assertion for system-only issuance seam with non-promoter registrar entry type.
