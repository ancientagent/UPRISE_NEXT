...
- Reduced shell padding and border radii to keep the collapsed player strip tighter against the locked mobile footprint.
- Tightened the track row, live badge padding, and footer spacing without adding or removing controls.
