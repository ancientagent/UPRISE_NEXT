# SLICE-ADMIN-400A — Registrar revocation invariants regression pack 5

## Scope
- Reinforced revocation invariants and invalid-state regressions in current service/controller paths.
- Added deterministic message assertions for missing active grant and null source-linkage mismatch states.
...
## Queue Transition
```text
{"completed":true,"resultCode":"completed","taskId":"SLICE-ADMIN-400A","updatedAt":"2026-02-28T05:40:08.064Z"}
```
