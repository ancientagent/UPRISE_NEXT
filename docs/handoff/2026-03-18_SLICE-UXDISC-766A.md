...
## Implementation
- Tightened the Discover pioneer-routing note to the canon phrase `top-right notification icon in the profile strip`.
- Kept the inactive/unavailable fallback and selected-parent-community wording intact.
