...
## Scope
- Ran the final targeted Batch17 replay for Plot, Discovery, and Player/Profile surfaces.
...
- Blocked:
  - `SLICE-UXQAREV-603A`
    - docs/spec wording already aligns, but `/plot` still renders deferred `Social` in the collapsed MVP tab rail

## Residual Notes
- Final targeted Batch17 gate replay is green.
- The remaining lane E blocker is documented in `docs/handoff/2026-03-16_SLICE-UXQAREV-603A_BLOCKED.md`.
- Batch17 risk/rollback guidance is documented in `docs/handoff/2026-03-16_SLICE-UXQAREV-604A.md`.
