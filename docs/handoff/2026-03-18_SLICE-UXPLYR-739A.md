...
- Confirmed the current title helper already satisfies the Batch22 tier-label contract.
- Added focused regression coverage proving the fallback label remains `UPRISE` when no anchor or home-scene label data exists.
