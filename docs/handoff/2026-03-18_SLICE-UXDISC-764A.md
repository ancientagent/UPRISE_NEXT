...
## Implementation
- Added a regression assertion proving fallback scene details are preserved when the primary transport payload includes only `tunedSceneId`.
- No product code path changed; the slice tightens tested handoff integrity only.
