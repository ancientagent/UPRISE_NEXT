...
- Extended `scripts/reliant-verify-transcript.test.mjs` to lock:
  - normalized markdown exit metadata
  - normalized JSON exit metadata
  - chained-command output ordering
