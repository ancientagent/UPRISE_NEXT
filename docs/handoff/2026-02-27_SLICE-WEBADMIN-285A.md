# SLICE-WEBADMIN-285A — Project/sect detail read nullable-field parity tests

## Summary
- Strengthened nullable-field parity tests for project and sect detail read responses in web typed client coverage.
- Added focused read-contract assertions only; no new user-facing actions.
