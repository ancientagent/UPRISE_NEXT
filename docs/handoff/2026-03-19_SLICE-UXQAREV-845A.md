...
## Scope
- Executed the final targeted gate replay for all Batch25-touched Plot, Discovery, and Player/Profile surfaces.
...
## Result
- Final Batch25 targeted replay passed cleanly across Plot, Discovery, and Player/Profile surfaces.
