...
- Confirmed the current title helper already satisfies the Batch26 tier-label contract.
- Added focused regression coverage proving anchor location data stays authoritative over home-scene location fallback.
