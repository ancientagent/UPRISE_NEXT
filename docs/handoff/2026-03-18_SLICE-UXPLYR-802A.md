...
- Confirmed the existing expanded-profile header and workspace composition already satisfy the Batch24 lock.
- Added a focused regression assertion proving the locked Merch category set remains intact.
