...
- Reduced shell and track-row density slightly to keep the collapsed player strip tighter against the locked mobile footprint.
- Tightened the mode chip, rotation chips, and live badge spacing without adding or removing controls.
