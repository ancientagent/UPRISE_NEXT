...
- Added field-level helper copy beneath the Music Community input making the MVP search scope explicit.

## Drift Guard Confirmation
- Touched locked decision: Discover search remains scene/community-only.
- Confirmed unchanged: no artist/band search entry or results behavior was introduced.
- Confirmed unchanged: no pricing, entitlement, recommendation, or ranking copy was added.

## Files Touched
- `apps/web/src/app/discover/page.tsx`
- `docs/CHANGELOG.md`
- `docs/handoff/2026-03-17_SLICE-UXDISC-612A.md`
