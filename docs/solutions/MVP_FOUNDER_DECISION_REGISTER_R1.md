...
| R1-DEC-005 | What numeric tier-propagation batch cap should the compatibility field `GRADUATION_CAP_PER_RUN` use? | Cap is declared with unresolved value (`TBD`) and does not govern New Releases-to-Main Rotation graduation. | `docs/specs/DECISIONS_REQUIRED.md`, `docs/specs/broadcast/radiyo-and-fair-play.md` | Do not set or hardcode a tier-propagation batch-cap value. |
