...
| Signals / Universal Actions | Partial | `CORE-SIGNALS` endpoints and idempotent actions implemented | Broader discourse/proof-of-support extensions | Integrate clear UX paths without ranking implications |
