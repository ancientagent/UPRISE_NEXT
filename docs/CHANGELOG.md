...
## [Unreleased]
### Added
- Rebased the shared Plot/Discover UI primitives from the overly literal paper/tape treatment to a darker legacy-inspired modern shell, using the old mobile palette as inspiration while preserving the existing route behavior contracts; see `docs/handoff/2026-03-25_plot-discover-legacy-modern-refresh.md`.
