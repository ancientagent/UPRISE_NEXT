...
- Added a `homeSceneCommunity` migration-safe read-path inventory that maps current runtime usages by owner lane and sequences cleanup after the shared default-preference resolver, write-path sync, and staging data verification.
