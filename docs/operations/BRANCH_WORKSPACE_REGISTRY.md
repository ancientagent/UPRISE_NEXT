...
| active-pm-post-branch-registry-refresh | branch | docs/active-pm-post-branch-registry-refresh | /home/baris/UPRISE_NEXT | PR #182 | main | pending | open-pr | Codex local | Codex local | Refresh ACTIVE_PM and branch workspace registry after PR #181 merged. | 2026-07-02 | merge via PR if green, then delete branch |
