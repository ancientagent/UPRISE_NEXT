...
| shared-local-fable-handoff | branch | fable/handoff | /home/baris/UPRISE_NEXT | - | main@ba969f8 | 5a3546c | active | Codex local, sole writer | Codex local; UPRISE Hermes profile curator | Preserves the Fable handoff/tooling guide and records the bounded UPRISE automation profile loadouts. No runtime/product changes. | 2026-08-16 | validate docs and profile smoke checks, then preserve this handoff and resume the RADIYO worker plan from a fresh packet |
