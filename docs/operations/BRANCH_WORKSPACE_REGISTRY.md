...
| post-227-branch-hygiene-refresh | branch | docs/post-227-branch-hygiene-refresh | /home/baris/UPRISE_NEXT | - | main | 354e6f4 | active | Codex local | Codex local | Refresh Active PM and branch workspace registry after PR #227 merged; classify branch/worktree hygiene findings and remote cleanup candidates without deleting refs. | 2026-07-07 | open PR, merge after docs lint/workspace audit; remote deletion requires separate explicit approval |
| main-workspace | primary | main | /home/baris/UPRISE_NEXT | - | origin/main | 354e6f4 | primary | Codex local | current branch owner | Primary UPRISE workspace on current main after PR #227. | 2026-07-07 | keep current and clean |
