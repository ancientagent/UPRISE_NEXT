...
| artist-profile-source-dashboard-specs | branch | docs/artist-profile-source-dashboard-specs | /home/baris/UPRISE_NEXT | - | main | pending | active | Codex local | Codex local; Codex worker subagents for Dev Spec and Design Spec lanes | Create the Artist Profile / Source Dashboard screen-package Dev Spec and Design Spec in parallel from the shared package packet. | 2026-07-04 | open PR after package gates validate; merge when docs lint/workspace audit pass. |
