...
| first-pass-implementation-workflow | branch | docs/uprise-first-pass-implementation-workflow | /home/baris/UPRISE_NEXT | PR #215 https://github.com/ancientagent/UPRISE_NEXT/pull/215 | main | pending | open-pr | Codex local | Codex local | Clarify that UPRISE execution packets support first-pass implementation as well as cleanup; GISTer-style source-behavior cleanup is conditional, not default. | 2026-07-03 | merge after checks, then refresh PM/registry |
