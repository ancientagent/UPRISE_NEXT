...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| main-workspace | primary | main | /home/baris/UPRISE_NEXT | - | origin/main | 79467df | primary | Codex local | current branch owner | Primary UPRISE workspace on current main after PR #182. | 2026-07-02 | keep current and clean |
...
| ux-reference-extraction-inventory | branch | docs/ux-reference-extraction-inventory | /home/baris/UPRISE_NEXT | PR #183 | main | pending | open-pr | Codex local | Codex local | Read-only extraction inventory for preserved UX reference worktrees ux-implementation and ux-mobile-r1-build. | 2026-07-02 | merge docs inventory via PR if green; no prototype merge |
