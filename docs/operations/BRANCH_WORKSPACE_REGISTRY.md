...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| main-workspace | primary | main | /home/baris/UPRISE_NEXT | - | origin/main | ce6c841 | primary | Codex local | current branch owner | Primary UPRISE workspace on current main after PR #186. | 2026-07-02 | keep current and clean |
...
| codex-first-review-routing-refresh | branch | docs/codex-first-review-routing-refresh | /home/baris/UPRISE_NEXT | PR #187 | main | pending | open-pr | Codex local | Codex local | Formalize Codex-first review/audit routing in documentation-framework and local UPRISE routing skill; Hermes fallback/watchdog only. | 2026-07-02 | merge docs/tooling refresh via PR if green |
