...
| main-workspace | primary | main | /home/baris/UPRISE_NEXT | - | origin/main | ba969f8 | primary | Codex local | current branch owner | Primary UPRISE baseline after historical cleanup PR #248. | 2026-07-23 | keep current and clean |
| classic-avatar-asset-production | branch | codex/classic-avatar-asset-production | /home/baris/UPRISE_NEXT | - | main@ba969f8 | pending | active | Codex local | Product Design; Creative Production; founder review gates | Lock the classic Plot/Home Scene avatar direction and create the first modular construction proof; no editor/runtime implementation. | 2026-07-23 | stop at founder Gate 2 review before expanding the catalog |
