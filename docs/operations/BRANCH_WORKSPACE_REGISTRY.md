...
| main-workspace | primary | main | /home/baris/UPRISE_NEXT | - | origin/main | 9910151 | primary | Codex local | current branch owner | Primary UPRISE workspace on current main after PR #216. | 2026-07-03 | keep current and clean |
...
| final-pm-closeout-after-workflow-refresh | branch | docs/final-pm-closeout-after-workflow-refresh | /home/baris/UPRISE_NEXT | PR #217 https://github.com/ancientagent/UPRISE_NEXT/pull/217 | main | pending | open-pr | Codex local | Codex local | Final operations refresh after PR #216 merged; marks workflow refresh branches closed so Active PM is clean. | 2026-07-03 | merge after checks; stop refresh chain |
| executor-review-loop-protocol | branch | docs/executor-review-loop-protocol | /home/baris/UPRISE_NEXT | - | main | pending | active | Codex local | Codex local | Clarify UPRISE feature implementation loop: fresh executor gathers repo context and writes plan, independent reviewer checks plan/execution, failed review returns to executor. | 2026-07-03 | update on PR/merge/close/delete |
