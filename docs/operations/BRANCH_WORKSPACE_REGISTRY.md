...
| main-workspace | primary | main | /home/baris/UPRISE_NEXT | - | origin/main | 0cd181e | primary | Codex local | current branch owner | Primary UPRISE workspace on current main after PR #189. | 2026-07-02 | keep current and clean |
...
| plot-tab-surface-component | branch | refactor/plot-tab-surface-component | /home/baris/UPRISE_NEXT | PR #190 | main | pending | open-pr | Codex local | Codex local | Extract /plot non-expanded tab bar and active surface frame into a focused component while preserving route-owned tab state and tab body rendering. | 2026-07-02 | merge focused Plot structural cleanup via PR if tests pass |
