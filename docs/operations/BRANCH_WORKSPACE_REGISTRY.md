...
| release-deck-radiyo-sect-implementation-architecture | branch | plan/release-deck-radiyo-sect-implementation-architecture | /home/baris/UPRISE_NEXT | - | docs/release-deck-radiyo-sect-readiness-spec-promotion | 8df3807 | active | Codex local | Codex local | Map implementation architecture for Release Deck scheduling, Fair Play New Releases ingestion, and song-level Sect readiness; docs/planning only, no runtime/schema/provider/db changes. | 2026-07-08 | Update on PR/merge/close/delete. |
