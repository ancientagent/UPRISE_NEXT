...
| final-pm-closeout-after-workflow-refresh | branch | docs/final-pm-closeout-after-workflow-refresh | /home/baris/UPRISE_NEXT | - | main | pending | active | Codex local | Codex local | Final self-closing operations refresh after PR #216 merged; marks workflow refresh branches closed so Active PM is clean. | 2026-07-03 | update on PR/merge/close/delete |
