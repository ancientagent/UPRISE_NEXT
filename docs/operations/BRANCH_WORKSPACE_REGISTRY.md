...
| active-pm-post-codex-routing-v2-refresh | branch | docs/active-pm-post-codex-routing-v2-refresh | /home/baris/UPRISE_NEXT | - | main | pending | active | Codex local | Codex local | Refresh ACTIVE_PM and branch workspace registry after PR #187 Codex-first review routing merged. | 2026-07-02 | merge docs-only PM refresh via PR if green |
