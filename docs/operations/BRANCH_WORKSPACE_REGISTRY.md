...
| first-pass-implementation-workflow | branch | docs/uprise-first-pass-implementation-workflow | /home/baris/UPRISE_NEXT | - | main | 4d7fa63 | active | Codex local | Codex local | Clarify that UPRISE execution packets support first-pass implementation as well as cleanup; GISTer-style source-behavior cleanup is conditional, not default. | 2026-07-03 | open PR after docs lint/workspace audit; merge if checks pass |
