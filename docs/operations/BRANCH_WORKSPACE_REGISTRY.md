...
| active-pm-post-plot-tab-surface-refresh | branch | docs/active-pm-post-plot-tab-surface-refresh | /home/baris/UPRISE_NEXT | - | main | pending | active | Codex local | Codex local | Refresh ACTIVE_PM and branch workspace registry after PR #190 Plot tab surface extraction merged. | 2026-07-02 | merge docs-only PM refresh via PR if green |
