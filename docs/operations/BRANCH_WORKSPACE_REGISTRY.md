...
| feature-plan-review-gate | branch | docs/feature-plan-review-gate | /home/baris/UPRISE_NEXT | - | main | 50c6e8b | active | Codex local | Codex local | Add pre-implementation feature review and independent Codex development-plan review gates to UPRISE execution packet/readiness docs. | 2026-07-03 | update on PR/merge/close/delete |
