...
| active-pm-post-plot-profile-player-state-refresh | branch | docs/active-pm-post-plot-profile-player-state-refresh | /home/baris/UPRISE_NEXT | PR #186 | main | pending | open-pr | Codex local | Codex local | Refresh ACTIVE_PM and branch workspace registry after PR #185 Plot profile/player state contract merged. | 2026-07-02 | merge docs-only PM refresh via PR if green |
