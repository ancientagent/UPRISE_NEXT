...
| main-workspace | primary | main | /home/baris/UPRISE_NEXT | - | origin/main | 5a07d93 | primary | Codex local | current branch owner | Primary UPRISE workspace on current main after PR #197. | 2026-07-03 | keep current and clean |
...
| uprise-development-plan-r1 | branch | docs/uprise-development-plan-r1 | /home/baris/UPRISE_NEXT | PR #198 https://github.com/ancientagent/UPRISE_NEXT/pull/198 | origin/main | 1199f97 | open-pr | Codex local | Codex local; Codex subagents for read-only lane checks when useful | Create explicit UPRISE development plan and lightweight PM operating model from current main. | 2026-07-03 | merge docs-only PR after checks, then return main workspace to clean `main` |
| reliant-development-plan-queue | branch | chore/reliant-development-plan-queue | /home/baris/UPRISE_NEXT | PR #199 https://github.com/ancientagent/UPRISE_NEXT/pull/199 | origin/main | 8ad9a0d | open-pr | Codex local | Codex local | Add Reliant queue tooling for the current UPRISE Development Plan R1 without executing queued slices. | 2026-07-03 | merge tooling/docs PR after checks, then return main workspace to clean `main` |
| feed-blast-card-source-link-contract | branch | test/feed-blast-card-source-link-contract | /home/baris/UPRISE_NEXT | PR #200 https://github.com/ancientagent/UPRISE_NEXT/pull/200 | main | 897fc02 | open-pr | Codex local | Codex local | UPRISE-PLAN-001: Feed Blast card source-link contract tests. | 2026-07-03 | merge after checks, then return main workspace to clean `main` and start UPRISE-PLAN-002 |
| feed-travel-launch-boundary-tests | branch | test/feed-travel-launch-boundary-tests | /home/baris/UPRISE_NEXT | PR #201 https://github.com/ancientagent/UPRISE_NEXT/pull/201 | main | 74089fe | open-pr | Codex local | Codex local | UPRISE-PLAN-002: Feed Travel launch-boundary tests. | 2026-07-03 | merge after checks, then return main workspace to clean `main` and start UPRISE-PLAN-003 |
| plot-no-transport-boundary-tests | branch | test/plot-no-transport-boundary-tests | /home/baris/UPRISE_NEXT | PR #202 https://github.com/ancientagent/UPRISE_NEXT/pull/202 | main | 545ff16 | open-pr | Codex local | Codex local | UPRISE-PLAN-003: Plot no-transport boundary tests. | 2026-07-03 | merge after checks, then return main workspace to clean `main` and start UPRISE-PLAN-004 |
...
| release-deck-media-eligibility-hardening | branch | test/release-deck-media-eligibility-hardening | /home/baris/UPRISE_NEXT | PR #205 https://github.com/ancientagent/UPRISE_NEXT/pull/205 | main | 9b73e58 | open-pr | Codex local | Codex local | UPRISE-PLAN-006: Release Deck media eligibility hardening. | 2026-07-03 | merge after checks, then return main workspace to clean main and start UPRISE-PLAN-007 |
