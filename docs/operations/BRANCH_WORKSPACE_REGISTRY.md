...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| main-workspace | primary | main | /home/baris/UPRISE_NEXT | - | origin/main | 4ecbb37 | primary | Codex local | current branch owner | Primary UPRISE workspace on current main after PR #183. | 2026-07-02 | keep current and clean |
