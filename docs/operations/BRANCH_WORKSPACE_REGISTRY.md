...
| activation-readiness-transaction-revalidation | branch | test/activation-readiness-transaction-revalidation | /home/baris/UPRISE_NEXT | - | main | 1708f19 | active | Codex local | Codex local | UPRISE-PLAN-007: Activation readiness transaction revalidation closeout/hardening. | 2026-07-03 | verify transaction revalidation, update docs/handoff/changelog, open PR, merge after checks |
