...
| plot-tab-surface-component | branch | refactor/plot-tab-surface-component | /home/baris/UPRISE_NEXT | - | main | pending | active | Codex local | Codex local | Extract /plot non-expanded tab bar and active surface frame into a focused component while preserving route-owned tab state and tab body rendering. | 2026-07-02 | merge focused Plot structural cleanup via PR if tests pass |
