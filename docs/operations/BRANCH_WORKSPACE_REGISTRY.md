...
| source-listener-profile-boundary | branch | test/source-listener-profile-boundary | /home/baris/UPRISE_NEXT | PR #213 https://github.com/ancientagent/UPRISE_NEXT/pull/213 | main | aff437d | open-pr | Codex local | Codex local | Task 11: harden Source Dashboard / listener profile separation contract locks; no runtime/provider/db/schema/art changes. | 2026-07-03 | merge after checks/review, then return to main and start Task 12 |
