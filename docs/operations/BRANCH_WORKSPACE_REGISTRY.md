...
| plot-bottom-nav-component | branch | refactor/plot-bottom-nav-component | /home/baris/UPRISE_NEXT | - | main | pending | active | Codex local | Codex local | Extract /plot bottom navigation and UPRISE wheel overlay into a focused component while preserving route-owned state and behavior. | 2026-07-02 | merge focused Plot structural cleanup via PR if tests pass |
