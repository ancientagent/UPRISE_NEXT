...
| screen-package-flow-closeout-refresh | branch | docs/screen-package-flow-closeout-refresh | /home/baris/UPRISE_NEXT | - | main | pending | active | Codex local | Codex local | Refresh Active PM and branch registry after PR #225 merged; set next signal to Artist Profile / Source Dashboard Dev Spec and Design Spec package gates. | 2026-07-04 | open PR, merge when docs lint/workspace audit pass. |
