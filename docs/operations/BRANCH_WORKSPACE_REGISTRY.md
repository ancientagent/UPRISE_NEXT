...
| screen-package-agent-flow | branch | chore/screen-package-agent-flow | /home/baris/UPRISE_NEXT | - | main | dca4ffb | active | Codex local | Codex local; Codex subagents for spec/checker/workflow evaluation | Implement screen-package agent automation flow: repo docs, local/repo skill routing, screen-package seed, and deterministic screen-package workflow runner. | 2026-07-04 | Open PR after screen-package runner/docs validation. |
