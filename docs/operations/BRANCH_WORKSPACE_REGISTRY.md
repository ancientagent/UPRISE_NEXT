...
| screen-package-flow-closeout-refresh | branch | docs/screen-package-flow-closeout-refresh | /home/baris/UPRISE_NEXT | PR #226 https://github.com/ancientagent/UPRISE_NEXT/pull/226 | main | pending | open-pr | Codex local | Codex local | Refresh Active PM and branch registry after PR #225 merged; set next signal to Artist Profile / Source Dashboard Dev Spec and Design Spec package gates. | 2026-07-04 | merge when docs lint/workspace audit and required PR checks pass. |
