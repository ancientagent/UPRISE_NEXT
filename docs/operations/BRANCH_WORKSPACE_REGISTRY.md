...
| main-workspace | primary | main | /home/baris/UPRISE_NEXT | - | origin/main | 1bcbfa7 | primary | Codex local | current branch owner | Primary UPRISE workspace on current main after PR #213. | 2026-07-03 | keep current and clean |
...
| print-shop-source-event-path | branch | test/print-shop-source-event-path | /home/baris/UPRISE_NEXT | PR #214 https://github.com/ancientagent/UPRISE_NEXT/pull/214 | main | ce0522b | open-pr | Codex local | Codex local | Task 12: harden Print Shop source-facing event path, Plot Events read-only, and Archive Registrar/records ordering locks; no provider/db/schema/art changes. | 2026-07-03 | merge after checks/review, then return to main |
