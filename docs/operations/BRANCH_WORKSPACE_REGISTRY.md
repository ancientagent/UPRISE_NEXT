...
| codex-first-review-routing-refresh | branch | docs/codex-first-review-routing-refresh | /home/baris/UPRISE_NEXT | - | main | pending | active | Codex local | Codex local | Formalize Codex-first review/audit routing in documentation-framework and local UPRISE routing skill; Hermes fallback/watchdog only. | 2026-07-02 | merge docs/tooling refresh via PR if green |
