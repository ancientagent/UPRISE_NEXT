...
| shared-local-fable-handoff | branch | fable/handoff | /home/baris/UPRISE_NEXT | - | main@ba969f8 | pending | active | Codex local, sole writer | Codex local; HY3 plan auditor | Preserves the Fable handoff/tooling guide, records bounded UPRISE automation profile loadouts, and owns the city-tier RADIYO worker plan/Slice A. | 2026-08-16 | finish contract and implementation packet, then implement only untriggered no-schema Slice A; defer durable lease/runner deployment |
