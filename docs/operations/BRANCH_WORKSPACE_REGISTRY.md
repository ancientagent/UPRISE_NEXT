...
| lean-pr-standing-orders | branch | docs/lean-pr-standing-orders | /home/baris/UPRISE_NEXT | - | main | 05266e6 | active | Codex local | Codex local | Add lean PR standing orders so small/medium slices default to focused implementation, focused validation, bounded review only when risk justifies it, and no bookkeeping/CI-watch spirals. | 2026-07-04 | open PR after docs validation |
