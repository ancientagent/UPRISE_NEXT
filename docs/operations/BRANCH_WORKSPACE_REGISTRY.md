...
| main-workspace | primary | main | /home/baris/UPRISE_NEXT | - | origin/main | 7db890b | primary | Codex local | current branch owner | Primary UPRISE workspace on current main after PR #222. | 2026-07-04 | keep current and clean |
...
| launch-scope-blast-card-runtime | branch | feat/launch-scope-blast-card-runtime | /home/baris/UPRISE_NEXT | PR #223 https://github.com/ancientagent/UPRISE_NEXT/pull/223 | main | origin/feat/launch-scope-blast-card-runtime | active | Codex local | Codex local; independent Codex reviewer for plan/execution | Task 10: launch-scope Blast card runtime; harden source links and listen/load behavior for in-community Feed Blast signals while keeping Travel/Discover transport deferred. | 2026-07-04 | open PR after validation; route to independent execution review before merge |
