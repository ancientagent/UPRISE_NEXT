...
| screen-package-agent-flow | branch | chore/screen-package-agent-flow | /home/baris/UPRISE_NEXT | PR #225 https://github.com/ancientagent/UPRISE_NEXT/pull/225 | main | HEAD | open-pr | Codex local | Codex local; Codex subagents for spec/checker/workflow evaluation | Implement screen-package agent automation flow: repo docs, local/repo skill routing, screen-package seed, and deterministic screen-package workflow runner. | 2026-07-04 | draft PR open; merge after review/checks, then refresh PM/registry. |
