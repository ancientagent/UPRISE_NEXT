...
| main-workspace | primary | main | /home/baris/UPRISE_NEXT | - | origin/main | 0ab9ce2 | primary | Codex local | current branch owner | Primary UPRISE workspace on current main after PR #188. | 2026-07-02 | keep current and clean |
...
| plot-bottom-nav-component | branch | refactor/plot-bottom-nav-component | /home/baris/UPRISE_NEXT | PR #189 | main | pending | open-pr | Codex local | Codex local | Extract /plot bottom navigation and UPRISE wheel overlay into a focused component while preserving route-owned state and behavior. | 2026-07-02 | merge focused Plot structural cleanup via PR if tests pass |
