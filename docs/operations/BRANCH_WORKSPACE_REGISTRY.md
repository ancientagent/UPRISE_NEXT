...
| executor-review-loop-protocol | branch | docs/executor-review-loop-protocol | /home/baris/UPRISE_NEXT | PR #218 https://github.com/ancientagent/UPRISE_NEXT/pull/218 | main | pending | open-pr | Codex local | Codex local | Clarify UPRISE feature implementation loop: fresh executor gathers repo context and writes plan, independent reviewer checks plan/execution, failed review returns to executor. | 2026-07-03 | merge after docs/process checks pass; delete branch after merge |
