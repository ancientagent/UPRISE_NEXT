...
| main-workspace | primary | main | /home/baris/UPRISE_NEXT | - | origin/main | 3ff136a | primary | Codex local | current branch owner | Primary UPRISE workspace on current main after PR #218. | 2026-07-03 | keep current and clean |
...
| relaxed-pr-bookkeeping-rule | branch | docs/relaxed-pr-bookkeeping-rule | /home/baris/UPRISE_NEXT | PR #220 https://github.com/ancientagent/UPRISE_NEXT/pull/220 | main | pending | open-pr | Codex local | Codex local | Document relaxed self-closing PR bookkeeping rule: no follow-up PR solely to close the just-merged refresh row; use GitHub as live PR truth. | 2026-07-03 | merge after docs/process checks pass; do not open follow-up PR solely to close this row |
| skill-standing-orders-lightening | branch | docs/lighten-uprise-skill-standing-orders | /home/baris/UPRISE_NEXT | - | main | 95ca671 | active | Codex local | Codex local | Lighten UPRISE skill standing orders and repo routing docs so agents load specialist skills conditionally instead of by default. | 2026-07-03 | Open PR, validate docs/skills, merge if checks pass; no follow-up PR solely to close self-referential rows. |
