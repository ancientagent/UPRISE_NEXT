...
| linear-clean-context-agent-roles | branch | docs/linear-clean-context-agent-roles | /home/baris/UPRISE_NEXT | - | main | 25e06a2 | active | Codex local | Codex local | Clarify assigning-agent vs assigned-agent Linear clean-context protocol and founder confirmation ownership. | 2026-07-03 | update on PR/merge/close/delete |
