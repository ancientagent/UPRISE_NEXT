...
| release-deck-radiyo-sect-readiness-spec-promotion | branch | docs/release-deck-radiyo-sect-readiness-spec-promotion | /home/baris/UPRISE_NEXT | - | plan/release-deck-radiyo-sect-readiness | 6edd7f6 | active | Codex local | Codex local | Promote founder/Fable Release Deck, fixed New Releases window, Uprise-wide deck measurement, and song-level sect readiness clarifications into owner specs; docs only, no runtime/schema. | 2026-07-08 | update on PR/merge/close/delete |
