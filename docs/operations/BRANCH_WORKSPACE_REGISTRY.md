...
| main-workspace | primary | main | /home/baris/UPRISE_NEXT | - | origin/main | 05266e6 | primary | Codex local | current branch owner | Primary UPRISE workspace on current main after PR #223. | 2026-07-04 | keep current and clean |
...
| artist-profile-source-dashboard-specs | branch | docs/artist-profile-source-dashboard-specs | /home/baris/UPRISE_NEXT | PR #227 https://github.com/ancientagent/UPRISE_NEXT/pull/227 | main | pending | open-pr | Codex local | Codex local; Product Design sidecar context; Codex worker/reviewer agents | Artist Profile / Source Dashboard screen-package specs plus founder-session captures, source-dashboard visual/art handoff, public Artist Profile context, Home/Plot visual-language notes, and owner-spec/lane-brief promotions needed for downstream dev/design agents. | 2026-07-08 | push current branch to PR #227, review docs/design package, then merge when docs lint, workspace audit, and required PR checks pass |
