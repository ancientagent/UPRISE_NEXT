...
| ux-reference-extraction-inventory | branch | docs/ux-reference-extraction-inventory | /home/baris/UPRISE_NEXT | - | main | pending | active | Codex local | Codex local | Read-only extraction inventory for preserved UX reference worktrees ux-implementation and ux-mobile-r1-build. | 2026-07-02 | merge docs inventory via PR if green; no prototype merge |
