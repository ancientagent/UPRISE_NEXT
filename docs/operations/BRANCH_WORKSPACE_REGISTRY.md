...
| main-workspace | primary | main | /home/baris/UPRISE_NEXT | - | origin/main | 052016f | primary | Codex local | current branch owner | Primary UPRISE workspace on current main after PR #196. | 2026-07-03 | keep current and clean |
...
| feed-travel-launch-boundary-pm-refresh | branch | docs/feed-travel-launch-boundary-pm-refresh | /home/baris/UPRISE_NEXT | PR #197 https://github.com/ancientagent/UPRISE_NEXT/pull/197 | main | 8872600 | open-pr | Codex local | Codex local | Capture Feed Travel launch boundary nuance and refresh Active PM / branch registry after PR #194-#196 merged. | 2026-07-03 | merge docs-only clarification/PM refresh via PR if checks pass |
