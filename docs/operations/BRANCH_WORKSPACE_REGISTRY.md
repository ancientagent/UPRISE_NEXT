...
| active-pm-post-first-pass-workflow-refresh | branch | docs/active-pm-post-first-pass-workflow-refresh | /home/baris/UPRISE_NEXT | - | main | pending | active | Codex local | Codex local | Refresh Active PM and branch workspace registry after PR #215 first-pass implementation workflow clarification merged. | 2026-07-03 | update on PR/merge/close/delete |
