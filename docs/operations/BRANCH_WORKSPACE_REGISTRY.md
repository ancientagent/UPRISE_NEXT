...
| main-workspace | primary | main | /home/baris/UPRISE_NEXT | - | origin/main | ebbf317 | primary | Codex local | current branch owner | Primary UPRISE workspace on current main after PR #228. | 2026-07-08 | keep current and clean |
| release-deck-radiyo-sect-readiness-capture | branch | docs/release-deck-radiyo-sect-readiness-capture | /home/baris/UPRISE_NEXT | - | main | 2e53741 | active | Codex local | Codex local; Fable planning auditor after push | Founder-session capture for Release Deck/RADIYO/Sect readiness clarification so Fable can audit/plan from repo-visible context; no owner-spec promotion or runtime changes. | 2026-07-08 | update on PR/merge/close/delete |
| release-deck-radiyo-sect-readiness-plan | branch | plan/release-deck-radiyo-sect-readiness | /home/baris/UPRISE_NEXT | - | main | 47e5125 | active | Codex local | Fable planning auditor | Planning/audit only: reconcile founder Release Deck/RADIYO/sect readiness clarification with owner specs; no runtime code or migrations. | 2026-07-08 | update on PR/merge/close/delete |
| release-deck-radiyo-sect-readiness-spec-promotion | branch | docs/release-deck-radiyo-sect-readiness-spec-promotion | /home/baris/UPRISE_NEXT | https://github.com/ancientagent/UPRISE_NEXT/pull/231 | plan/release-deck-radiyo-sect-readiness | b11f783 | open-pr | Codex local | Codex local | Promote founder/Fable Release Deck, fixed New Releases window, Uprise-wide deck measurement, and song-level sect readiness clarifications into owner specs; docs only, no runtime/schema. | 2026-07-08 | Draft PR #231 open against plan/release-deck-radiyo-sect-readiness; update on merge/close/delete. |
| release-deck-radiyo-sect-implementation-architecture | branch | plan/release-deck-radiyo-sect-implementation-architecture | /home/baris/UPRISE_NEXT | https://github.com/ancientagent/UPRISE_NEXT/pull/232 | docs/release-deck-radiyo-sect-readiness-spec-promotion | 2296d6d | open-pr | Codex local | Codex local | Map implementation architecture for Release Deck scheduling, Fair Play New Releases ingestion, and song-level Sect readiness; docs/planning only, no runtime/schema/provider/db changes. | 2026-07-08 | Draft PR #232 open against docs/release-deck-radiyo-sect-readiness-spec-promotion; update on merge/close/delete. |
| release-deck-measurement-slice-1 | branch | feat/release-deck-measurement-slice-1 | /home/baris/UPRISE_NEXT | - | main | 81c9f03 | active | Codex local | Release Deck architecture implementer | Slice 1: read-only Uprise-wide Release Deck measurement service + GET /release-deck/measurement. No migration, no Fair Play ingestion, no scheduling/sect writes. | 2026-07-08 | update on PR/merge/close/delete |
