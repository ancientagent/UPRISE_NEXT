...
| main-workspace | primary | main | /home/baris/UPRISE_NEXT | - | origin/main | 236353e | primary | Codex local | current branch owner | Primary UPRISE workspace on current main after PR #214. | 2026-07-03 | keep current and clean |
...
| first-pass-implementation-workflow | branch | docs/uprise-first-pass-implementation-workflow | /home/baris/UPRISE_NEXT | PR #215 https://github.com/ancientagent/UPRISE_NEXT/pull/215 | main | 9ac44eb | open-pr | Codex local | Codex local | Clarify that UPRISE execution packets support first-pass implementation as well as cleanup; GISTer-style source-behavior cleanup is conditional, not default. | 2026-07-03 | merge after checks, then refresh PM/registry |
