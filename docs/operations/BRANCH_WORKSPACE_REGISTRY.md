...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| main-workspace | primary | main | /home/baris/UPRISE_NEXT | - | origin/main | 9285b25 | primary | Codex local | current branch owner | Primary UPRISE workspace on current main after PR #184. | 2026-07-02 | keep current and clean |
...
| plot-profile-player-state-contract | branch | test/plot-profile-player-state-contract | /home/baris/UPRISE_NEXT | PR #185 | main | pending | open-pr | Codex local | Codex local | Add current-compatible Plot profile/player state contract tests inspired by preserved UX reference state-machine work; no prototype runtime import. | 2026-07-02 | watch checks, squash merge if green, then return workspace to main |
