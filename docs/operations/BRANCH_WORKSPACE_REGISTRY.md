...
| source-listener-profile-boundary | branch | test/source-listener-profile-boundary | /home/baris/UPRISE_NEXT | - | main | 25e06a2 | active | Codex local | Codex local | Task 11: harden Source Dashboard / listener profile separation contract locks; no runtime/provider/db/schema/art changes. | 2026-07-03 | update on PR/merge/close/delete |
