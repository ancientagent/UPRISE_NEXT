...
| print-shop-source-event-path | branch | test/print-shop-source-event-path | /home/baris/UPRISE_NEXT | - | main | pending | active | Codex local | Codex local | Task 12: harden Print Shop source-facing event path, Plot Events read-only, and Archive Registrar/records ordering locks; no provider/db/schema/art changes. | 2026-07-03 | update on PR/merge/close/delete |
