...
| main-workspace | primary | main | /home/baris/UPRISE_NEXT | - | origin/main | 48d56e0 | primary | Codex local | current branch owner | Primary UPRISE workspace on current main after PR #215. | 2026-07-03 | keep current and clean |
...
| active-pm-post-first-pass-workflow-refresh | branch | docs/active-pm-post-first-pass-workflow-refresh | /home/baris/UPRISE_NEXT | PR #216 https://github.com/ancientagent/UPRISE_NEXT/pull/216 | main | pending | open-pr | Codex local | Codex local | Refresh Active PM and branch workspace registry after PR #215 first-pass implementation workflow clarification merged. | 2026-07-03 | update on PR/merge/close/delete |
