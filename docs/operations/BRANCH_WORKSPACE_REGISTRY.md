...
| skill-standing-orders-lightening | branch | docs/lighten-uprise-skill-standing-orders | /home/baris/UPRISE_NEXT | - | main | pending | active | Codex local | Codex local | Lighten UPRISE skill standing orders and repo routing docs so agents load specialist skills conditionally instead of by default. | 2026-07-03 | Open PR, validate docs/skills, merge if checks pass; no follow-up PR solely to close self-referential rows. |
