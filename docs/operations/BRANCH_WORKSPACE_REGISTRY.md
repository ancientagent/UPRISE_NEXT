...
| artist-profile-source-dashboard-specs | branch | docs/artist-profile-source-dashboard-specs | /home/baris/UPRISE_NEXT | PR #227 https://github.com/ancientagent/UPRISE_NEXT/pull/227 | main | a16c9a1 | open-pr | Codex local | Codex local; Codex worker subagents for Dev Spec, Design Spec, and Spec Package Review lanes | Create the Artist Profile / Source Dashboard screen-package Dev Spec and Design Spec in parallel from the shared package packet, then pass the spec-package review gate. | 2026-07-04 | merge when docs lint/workspace audit and required PR checks pass. |
