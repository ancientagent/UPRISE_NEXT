...
| tasks-1-7-closeout-refresh | branch | docs/tasks-1-7-closeout-refresh | /home/baris/UPRISE_NEXT | PR #207 https://github.com/ancientagent/UPRISE_NEXT/pull/207 | main | 926986b | open-pr | Codex local | Codex local | Docs-only closeout after UPRISE-PLAN-001 through UPRISE-PLAN-007 merged; refresh Active PM and branch registry. | 2026-07-03 | merge after docs lint/workspace audit; return to clean main |
| activation-tuple-normalized-matching | branch | test/activation-tuple-normalized-matching | /home/baris/UPRISE_NEXT | - | main | 0f7f100 | active | Codex local | Codex local; Codex reviewer required for feature/runtime changes | UPRISE-PLAN-008: Activation tuple normalized matching closeout. | 2026-07-03 | verify normalized matching, review if runtime changes, update docs/handoff/changelog, open PR, merge after checks |
