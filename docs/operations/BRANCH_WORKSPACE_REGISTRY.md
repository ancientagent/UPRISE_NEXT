...
| task8-task9-goal-closeout | branch | docs/task8-task9-goal-closeout | /home/baris/UPRISE_NEXT | PR #210 https://github.com/ancientagent/UPRISE_NEXT/pull/210 | main | pending | open-pr | Codex local | Codex local | Final docs-only closeout after UPRISE-PLAN-008 and Task 9 merged; refresh Active PM and branch registry for completed goal. | 2026-07-03 | merge after checks; return to clean main |
| feature-plan-review-gate | branch | docs/feature-plan-review-gate | /home/baris/UPRISE_NEXT | PR #211 https://github.com/ancientagent/UPRISE_NEXT/pull/211 | main | 2749d55 | open-pr | Codex local | Codex local | Add pre-implementation feature review and independent Codex development-plan review gates to UPRISE execution packet/readiness docs. | 2026-07-03 | merge after checks; return to clean main |
| linear-clean-context-agent-roles | branch | docs/linear-clean-context-agent-roles | /home/baris/UPRISE_NEXT | PR #212 https://github.com/ancientagent/UPRISE_NEXT/pull/212 | main | be8e32a | open-pr | Codex local | Codex local | Clarify assigning-agent vs assigned-agent Linear clean-context protocol and founder confirmation ownership. | 2026-07-03 | merge after checks; return to clean main |
