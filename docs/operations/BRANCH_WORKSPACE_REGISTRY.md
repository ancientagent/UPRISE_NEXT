...
| activation-tuple-normalized-matching | branch | test/activation-tuple-normalized-matching | /home/baris/UPRISE_NEXT | PR #208 https://github.com/ancientagent/UPRISE_NEXT/pull/208 | main | de30007 | open-pr | Codex local | Codex local; Codex reviewer approved runtime change | UPRISE-PLAN-008: Activation tuple normalized matching closeout. | 2026-07-03 | merge after checks; then start Task 9 Feed card family inventory |
