...
| main-workspace | primary | main | /home/baris/UPRISE_NEXT | - | origin/main | eea674c | primary | Codex local | current branch owner | Primary UPRISE workspace on current main after PR #187. | 2026-07-02 | keep current and clean |
...
| active-pm-post-codex-routing-v2-refresh | branch | docs/active-pm-post-codex-routing-v2-refresh | /home/baris/UPRISE_NEXT | PR #188 | main | pending | open-pr | Codex local | Codex local | Refresh ACTIVE_PM and branch workspace registry after PR #187 Codex-first review routing merged. | 2026-07-02 | merge docs-only PM refresh via PR if green |
