...
| main-workspace | primary | main | /home/baris/UPRISE_NEXT | - | origin/main | 64e65fe | primary | Codex local | current branch owner | Primary UPRISE workspace on current main after PR #221. | 2026-07-04 | keep current and clean |
...
| development-plan-closeout-refresh | branch | docs/development-plan-closeout-refresh | /home/baris/UPRISE_NEXT | PR #222 https://github.com/ancientagent/UPRISE_NEXT/pull/222 | main | c4ed895 | open-pr | Codex local | Codex local | Refresh UPRISE development plan and Active PM after PR #221 merged; identify Task 10 as the next real development signal after Tasks 1-9 and 11-12 already merged. | 2026-07-04 | update on PR/merge/close/delete |
