...
| Music-community preference runtime implementation | `docs/specs/users/onboarding-home-scene-resolution.md#music-community-preference-contract` | Persistence, backfill, API, and typed web wrappers exist; current-city resolution, roller filtering, profile UI, unresolved-profile visibility, and GPS voting scope across resolvable preferences remain implementation work. |
...
4. Continue Music-Community Preference runtime parity: current-city preference resolution, Home Scene roller read model, profile UI, unresolved-profile visibility, GPS voting scope across resolvable registered preferences, and migration cleanup after the new preference model is fully adopted.
