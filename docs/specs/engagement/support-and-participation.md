...
- The bounded aggregate Support behind a Sect potential is intended to give
  prospective artists credible evidence of fan interest. Artist-facing
  presentation may use that signal to persuade registration and explicit Sect
  membership, but it cannot imply consent or count as source membership.
