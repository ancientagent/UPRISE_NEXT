...
1. `docs/FEATURE_DRIFT_GUARDRAILS.md` — “spec‑first / no drift” policy.
2. `docs/RUNBOOK.md` — operations + verification expectations.
3. `apps/web/WEB_TIER_BOUNDARY.md` — strict boundary: web is untrusted; no DB/secrets in web tier.
